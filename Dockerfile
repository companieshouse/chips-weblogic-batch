...
RUN mkdir -p ${ORACLE_HOME}/libs && \
    ...
    curl -L -u "${ARTIFACTORY_USERNAME}:${ARTIFACTORY_PASSWORD}" ${ARTIFACTORY_BASE_URL}/uk/gov/companieshouse/doc1-producer/2.0.5/doc1-producer-2.0.5.jar -o ../doc1-producer/doc1-producer.jar && \
