...
RUN mkdir -p ${ORACLE_HOME}/libs && \
    ...
    curl -L -u "${ARTIFACTORY_USERNAME}:${ARTIFACTORY_PASSWORD}" ${ARTIFACTORY_BASE_URL}/uk/gov/companieshouse/jmstool/1.6.0/jmstool-1.6.0.jar -o jmstool.jar && \
    ...
    curl -L -u "${ARTIFACTORY_USERNAME}:${ARTIFACTORY_PASSWORD}" ${ARTIFACTORY_BASE_URL}/uk/gov/companieshouse/doc1-producer/2.0.0/doc1-producer-2.0.0.jar -o ../doc1-producer/doc1-producer.jar && \
