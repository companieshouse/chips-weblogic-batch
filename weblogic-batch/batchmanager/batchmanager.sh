...
CLASSPATH=$CLASSPATH:.:/apps/oracle/libs/spring-core-4.3.30.RELEASE.jar:/apps/oracle/libs/spring-beans-4.3.30.RELEASE.jar:/apps/oracle/libs/spring-context-4.3.30.RELEASE.jar:/apps/oracle/libs/spring-jms-4.3.30.RELEASE.jar:/apps/oracle/libs/spring-aop-4.3.30.RELEASE.jar:/apps/oracle/libs/spring-expression-4.3.30.RELEASE.jar:/apps/oracle/libs/javax.jms-api-2.0.1.jar:/apps/oracle/libs/log4j-api-2.25.3.jar:/apps/oracle/libs/log4j-core-2.25.3.jar:/apps/oracle/libs/log4j-jcl-2.25.3.jar:/apps/oracle/libs/wlthint3client-14.1.2.0.jar:/apps/oracle/batchmanager/batch-manager.jar
