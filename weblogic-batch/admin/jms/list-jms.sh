...
CLASSPATH=${LIBS}/jmstool.jar:${LIBS}/log4j.jar:${LIBS}/jms-api.jar:${LIBS}/wlfullclient.jar:${LIBS}/jdom.jar:${LIBS}/image-sender.jar:${LIBS}/javax.ws.rs-api.jar:${LIBS}/chips-common.jar
