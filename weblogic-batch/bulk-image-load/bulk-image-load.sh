...
/usr/java/jdk/bin/java -Din=bulk-image-load -cp $CLASSPATH -Dlog4j.configurationFile=classpath:log4j2.xml uk.gov.companieshouse.bulkimageload.BulkImageLoadRunner bulk-image-load.properties
if [ $? -gt 0 ]; then
